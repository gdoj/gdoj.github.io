"use strict";
{
  ...
  const newcatalog = {
    ...
    "Chosen %s": "Ch\u1ecdn %s",
    "Click to choose all %s at once.":
      "Click \u0111\u1ec3 ch\u1ecdn t\u1ea5t c\u1ea3 %s .",
    "Click to remove all chosen %s at once.":
      "Click \u0111\u1ec3 b\u1ecf ch\u1ecdn t\u1ea5t c\u1ea3 %s",
    Filter: "L\u1ecdc",
    Hide: "D\u1ea5u \u0111i",
    Midnight: "N\u1eeda \u0111\u00eam",
    Noon: "Bu\u1ed5i tr\u01b0a",
    ...
    'This is the list of available %s. You may choose some by selecting them in the box below and then clicking the "Choose" arrow between the two boxes.':
      'Danh s\u00e1ch c\u00e1c l\u1ef1a ch\u1ecdn \u0111ang c\u00f3 %s. B\u1ea1n c\u00f3 th\u1ec3 ch\u1ecdn b\u1eb1ng b\u00e1ch click v\u00e0o m\u0169i t\u00ean "Ch\u1ecdn" n\u1eb1m gi\u1eefa hai h\u1ed9p.',
    'This is the list of chosen %s. You may remove some by selecting them in the box below and then clicking the "Remove" arrow between the two boxes.':
      'Danh s\u00e1ch b\u1ea1n \u0111\u00e3 ch\u1ecdn %s. B\u1ea1n c\u00f3 th\u1ec3 b\u1ecf ch\u1ecdn b\u1eb1ng c\u00e1ch click v\u00e0o m\u0169i t\u00ean "Xo\u00e1" n\u1eb1m gi\u1eefa hai \u00f4.',
    Today: "H\u00f4m nay",
    Tomorrow: "Ng\u00e0y mai",
    "Type into this box to filter down the list of available %s.":
      "B\u1ea1n h\u00e3y nh\u1eadp v\u00e0o \u00f4 n\u00e0y \u0111\u1ec3 l\u1ecdc c\u00e1c danh s\u00e1ch sau %s.",
    Yesterday: "H\u00f4m qua",
    "You have selected an action, and you haven't made any changes on individual fields. You're probably looking for the Go button rather than the Save button.":
      "B\u1ea1n \u0111\u00e3 l\u1ef1a ch\u1ecdn m\u1ed9t h\u00e0nh \u0111\u1ed9ng, v\u00e0 b\u1ea1n \u0111\u00e3 kh\u00f4ng th\u1ef1c hi\u1ec7n b\u1ea5t k\u1ef3 thay \u0111\u1ed5i n\u00e0o tr\u00ean c\u00e1c tr\u01b0\u1eddng. C\u00f3 l\u1ebd b\u1ea1n \u0111ang t\u00ecm ki\u1ebfm n\u00fat b\u1ea5m Go thay v\u00ec n\u00fat b\u1ea5m Save.",
    "You have selected an action, but you haven't saved your changes to individual fields yet. Please click OK to save. You'll need to re-run the action.":
      "B\u1ea1n \u0111\u00e3 l\u1ef1a ch\u1ecdn m\u1ed9t h\u00e0nh \u0111\u1ed9ng, nh\u01b0ng b\u1ea1n kh\u00f4ng l\u01b0u thay \u0111\u1ed5i c\u1ee7a b\u1ea1n \u0111\u1ebfn c\u00e1c l\u0129nh v\u1ef1c c\u00e1 nh\u00e2n \u0111\u01b0\u1ee3c n\u00eau ra. Xin vui l\u00f2ng click OK \u0111\u1ec3 l\u01b0u l\u1ea1i. B\u1ea1n s\u1ebd c\u1ea7n ph\u1ea3i ch\u1ea1y l\u1ea1i c\u00e1c h\u00e0nh \u0111\u1ed9ng.",
    "You have unsaved changes on individual editable fields. If you run an action, your unsaved changes will be lost.":
      "B\u1ea1n ch\u01b0a l\u01b0u nh\u1eefng tr\u01b0\u1eddng \u0111\u00e3 ch\u1ec9nh s\u1eeda. N\u1ebfu b\u1ea1n ch\u1ecdn h\u00e0nh \u0111\u1ed9ng n\u00e0y, nh\u1eefng ch\u1ec9nh s\u1eeda ch\u01b0a \u0111\u01b0\u1ee3c l\u01b0u s\u1ebd b\u1ecb m\u1ea5t.",
    "time format with day\u0004%d day %h:%m:%s": ["%d ng\u00e0y %h:%m:%s"],
  ...
  function stopHandler(event) {
    ...
    if (!$elem.data("taphold_triggered") && !$elem.data("taphold_clicked")) {
      if (typeof $elem.data("taphold_click_handler") == "function") {
        $elem.data("taphold_click_handler")(
          jQuery.extend(event, jQuery.Event("click"))
        );
      }
  ...
  var taphold = ($.event.special.taphold = {
    setup: function (data) {
      $(this)
        ...
        .bind(
          touchSupported ? "touchmove touchcancel" : "mouseleave",
          leaveHandler
        );
    },
  ...
  elems.each(function () {
    ...
    function update() {
      ...
      if (moment().diff(time, "seconds") < limit) {
        ...
        $this.text(
          rel_format.replace("{time}", time.format("h:mm:ss a, DD/MM/YYYY"))
        );
      }
...
window.notification_template = { icon: "/logo.png" };
...
function WSEventDispatcher(websocket_path, polling_base, last_msg) {
  ...
  function init_websocket() {
    ...
    receiver.websocket.onopen = function () {
      receiver.websocket.send(
        JSON.stringify({ command: "start-msg", start: receiver.last_msg })
      );
    ...
    receiver.websocket.onclose = function (event) {
      if (receiver.auto_reconnect) {
        console.log(
          "Lost websocket connection! Attempt reconnecting in 1 second..."
        );
    ...
    if (window.WebSocket) {
      filter_timeout = setTimeout(function () {
        if (
          ...
          receiver.websocket.send(
            JSON.stringify({ command: "set-filter", filter: receiver.channels })
          );
        } else {
          set_filters();
        }
